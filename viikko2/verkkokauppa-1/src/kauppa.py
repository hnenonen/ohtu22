from varasto import varasto_olio
from pankki import pankki_olio
from ostoskori import Ostoskori
from viitegeneraattori import viite_olio


class Kauppa:
    def __init__(self, varasto = varasto_olio, pankki = pankki_olio, viite = viite_olio):
